...
public class ShaderGradientDrawer : MaterialPropertyDrawer
{
    ...
    public ShaderGradientDrawer()
    {
        resolution = 64;
    }

    public ShaderGradientDrawer(float res)
    {
        resolution = (int)res;
    }
    ...
    public override void OnGUI(Rect position, MaterialProperty prop, GUIContent label, MaterialEditor editor)
    {
        ...
        {
            EditorGUI.HelpBox(position, "Save Material To Folder to use this effect", MessageType.Error);
            return;
        }
    ...
    [MenuItem("Assets/Remove All Gradient Textures")]
